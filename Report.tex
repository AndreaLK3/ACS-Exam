...
~\\
My \textbf{workload} considers 3 kinds of interactions:
\begin{itemize}
...
\end{itemize}
I planned on measuring the throughput of successful interactions, for each kind, scaling the number of clients.\\
Unfortunately, I encountered a problem in the communication with the CTM, and I do not have had the time to fix it.\\
