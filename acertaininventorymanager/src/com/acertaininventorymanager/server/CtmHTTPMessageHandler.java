...
public class CtmHTTPMessageHandler extends AbstractHandler {
	...
	private void removeOrders(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		try {
			myInvManager.removeOrders(purchases);
